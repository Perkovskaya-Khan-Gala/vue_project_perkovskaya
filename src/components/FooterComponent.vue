<template>
  <footer class="footer center">
    ...
    <div class="footer_contact">
      ...
      <div class="footer_info">55 East Birchwood Ave. Brooklyn, New York 11201</div>
      <div class="footer_info footer_margin">contact@interno.com</div>
      <div class="footer_info footer_margin">(123) 456 - 7890</div>
    </div>
  </footer>
</template>
